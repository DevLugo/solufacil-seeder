...
const saveDataToDB = async (loans, cashAccountId, bankAccount, payments) => {
    ...
    const batches = (0, utils_1.chunkArray)(notRenovatedLoans, 25); // Aumentado de 5 a 25
    ...
    const renovatedBatches = (0, utils_1.chunkArray)(renovatedLoans, 20); // Aumentado de 10 a 20
